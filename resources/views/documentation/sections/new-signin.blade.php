...
<section id="new-signin" class="mb-12">
  ...
  <ol class="space-y-2 list-decimal list-inside">
    ...
    <span class="inline-block px-2 py-1 font-mono text-sm text-white bg-black rounded">POST {base_url}/get-phone-otp</span>
    ...
    <span class="inline-block px-2 py-1 font-mono text-sm text-white bg-black rounded">POST {base_url}/verify-otp-byphone</span>
    ...
    <span class="inline-block px-2 py-1 font-mono text-sm text-white bg-black rounded">POST [base_url]/register-user-details</span>
    
    <li>Details are updated to the temp account (and activating it to full account) and user is authenticated expect a TOKEN</li>
...
<section id="new-signin" class="mb-12">
  ...
  <ol class="space-y-2 list-decimal list-inside">
    <li>Enters phone to receive an SMS – <code class="px-1 bg-gray-100 rounded">Step1 – GetPhoneOTP</code></li>
    <span class="inline-block px-2 py-1 font-mono text-sm text-white bg-black rounded">POST {base_url}/get-email-otp</span>

    <li>Temp account will be created and OTP SMS is sent to user</li>
    
    <li>User enters OTP to be verified – <code class="px-1 bg-gray-100 rounded">Step2 – verifyOtpViaPhone</code></li>
    <span class="inline-block px-2 py-1 font-mono text-sm text-white bg-black rounded">POST {base_url}/verify-otp-byemail</span>
