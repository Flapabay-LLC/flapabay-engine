...
class StorelistingTypeRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'name.required' => 'The listing type name is required.',
            'name.unique' => 'This listing type name already exists.',
            ...
            'type.required' => 'The listing type category is required.'
        ];
    }
}
