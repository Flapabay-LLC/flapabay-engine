    ...
    public function run(): void
    {
            ...
            $categories = [
                [
                    ...
                    'description' => 'listings located on the beachfront.',
                ],
                [
                    'name' => 'Mountain Retreat',
                    'icon' => 'mountain-icon.png',
                    'icon_alt' => 'Mountain Retreat Icon',
                    'description' => 'listings nestled in the mountains.',
                ],
                [
                    'name' => 'Urban Living',
                    'icon' => 'urban-icon.png',
                    'icon_alt' => 'Urban Living Icon',
                    'description' => 'listings located in the heart of the city.',
                ],
                [
                    'name' => 'Countryside',
                    'icon' => 'countryside-icon.png',
                    'icon_alt' => 'Countryside Icon',
                    'description' => 'listings in peaceful countryside areas.',
                ],
                [
                    'name' => 'Luxury Villas',
