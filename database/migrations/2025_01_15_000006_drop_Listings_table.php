...
return new class extends Migration
{
    ...
    {
        // Migration disabled: Do not drop the listings table as seeders still depend on it
        // The listings table is still needed for the application to function properly
    ...
    {
        // Recreate the listings table structure (basic version)
        ...
        Schema::create('listings', function (Blueprint $table) {
            ...
            $table->enum('listing_type', ['Featured', 'Guest Favorite', 'Others'])->nullable();
